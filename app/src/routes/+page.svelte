...
{#if drag.active}
	<div
		class="pointer-events-none fixed z-[9999] rounded-sm border border-border bg-background px-2.5 py-[5px] text-xs font-medium whitespace-nowrap text-foreground shadow-[var(--shadow-lg)]"
