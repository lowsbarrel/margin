...
export async function encryptBlob(plaintext: Uint8Array, key: number[]): Promise<Uint8Array> {
...
export async function decryptBlob(ciphertext: Uint8Array, key: number[]): Promise<Uint8Array> {
